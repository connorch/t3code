...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.sourceControlEnableAutomerge]: AuthOrchestrationOperateScope,
  ...
  [WS_METHODS.vcsArchiveWorktree]: AuthOrchestrationOperateScope,
  [WS_METHODS.vcsUnarchiveWorktree]: AuthOrchestrationOperateScope,
  [WS_METHODS.vcsListWorktreeArchives]: AuthOrchestrationReadScope,
